...
async function promptBotConfig(rl: ReturnType<typeof createInterface>): Promise<Record<string, any> | null> {
  ...
  console.log('支持的 CLI: 1) claude-code  2) aiden  3) coco  4) codex  5) cursor  6) gemini  7) opencode  8) antigravity  9) mtr  10) hermes');
...
async function promptEditBotConfig(
  ...
  console.log('\n支持的 CLI: 1) claude-code  2) aiden  3) coco  4) codex  5) cursor  6) gemini  7) opencode  8) antigravity  9) mtr  10) hermes');
