...
- **Node.js** >= 20
- **AI 编程 CLI / 本地 Agent 应用** 已安装并完成认证（`claude`、`codex`、`coco`、`cursor-agent`、`gemini`、`opencode`、`hermes`、`seed`（Seed CLI，Claude Code 衍生）、`pi`、`copilot`（GitHub Copilot CLI）或 `agy`（Antigravity）在 PATH 中）
